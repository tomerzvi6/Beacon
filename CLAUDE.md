...
- AI summaries הם static strings מתוך `SampleAISummaries.swift` — לא Claude API אמיתי
...
| מה | איפה | הערה |
|---|---|---|
| Claude / AI אמיתי | `AIServiceProtocol` (לא קיים עדיין) | להזריק ל-`MedicalVaultViewModel` |
